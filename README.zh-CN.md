...
这就是 `better-code` 做的事——[Full Context + Lite Control](https://github.com/d-wwei/better-work-skill) 框架里研发那一半的落地。一份 150 行的项目记忆，告诉 agent 那些它从代码本身看不到的东西。
...
- **[better-work-skill](https://github.com/d-wwei/better-work-skill)** — Lite Control 层 + 系列入口。完整的设计故事看那里。
- **better-code**（本 repo） — 研发 Full Context
- **[better-test](https://github.com/d-wwei/better-test)** — 测试 Full Context

`better-code` 独立可用。装了 `better-work-skill` 之后，`/better-work code <cmd>` 成为别名，行为一致。
